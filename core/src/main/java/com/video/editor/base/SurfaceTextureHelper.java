...
import com.video.editor.gles.EglBase;
import com.video.editor.gles.GlUtil;
import com.video.editor.gles.RendererCommon;
...
public class SurfaceTextureHelper {
  ...
  private void tryDeliverTextureFrame() {
    ...
    final VideoFrame.TextureBuffer buffer =
        new TextureBufferImpl(textureWidth, textureHeight, VideoFrame.TextureBuffer.Type.OES, oesTextureId,
