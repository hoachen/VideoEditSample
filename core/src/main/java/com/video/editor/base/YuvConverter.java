...
import com.video.editor.gles.GlGenericDrawer;
import com.video.editor.gles.GlShader;
import com.video.editor.gles.GlTextureFrameBuffer;
import com.video.editor.gles.GlUtil;
import com.video.editor.gles.VideoFrameDrawer;
...
public final class YuvConverter {
  ...
  private VideoFrame.I420Buffer convertInternal(VideoFrame.TextureBuffer inputTextureBuffer) {
    VideoFrame.TextureBuffer preparedBuffer = (VideoFrame.TextureBuffer) videoFrameDrawer.prepareBufferForViewportSize(
